...
from layers.graphsage_layer import GraphSageLayer, DenseGraphSage   # this is GraphSageLayer, DiffPoolBatchedGraphLayer
from layers.diffpool_layer import DiffPoolLayer, DenseDiffPool   # this is GraphSageLayer, DiffPoolBatchedGraphLayer
...
class DiffPoolNet(nn.Module):
    ...
    def __init__(self, net_params, pool_ratio=0.5):
        ...
        embedding_dim = net_params['hidden_dim']  # net_params['embedding_dim']
        ...
        self.link_pred = True  # net_params['linkpred']
        self.concat = False  # net_params['cat']
        self.n_pooling = 1  # net_params['num_pool']
        ...
        self.assign_dim = int(net_params['max_num_node'] * pool_ratio) * self.batch_size  # net_params['assign_dim']
        self.bn = True
        self.num_aggs = 1
        ...
        self.first_diffpool_layer = DiffPoolLayer(pool_embedding_dim, self.assign_dim, hidden_dim,
                                                  activation, dropout, aggregator_type, self.link_pred, self.batch_norm)
